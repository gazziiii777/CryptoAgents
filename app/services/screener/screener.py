...
from app.adapters.clients.coinglass.exceptions import CoinGlassAuthError
from app.services.screener.evaluation import evaluate_symbol
from app.domain.models.screener import ScreenerResult
from app.services.screener.universe import get_screening_universe
...
async def run_screener(limit: int | None = None) -> list[ScreenerResult]:
    ...
    """
    symbols = await get_screening_universe()
