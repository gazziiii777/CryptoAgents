...
from app.adapters.clients.ccxt.models import (
...
class CcxtClient:
    ...
    async def fetch_last_prices(self, symbols: list[str]) -> dict[str, float]:
        """last-цена по списку символов одним запросом fetch_tickers (для mark-price)."""
