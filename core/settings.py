...
class Settings(BaseSettings):
    ...
    CONFLUENCE_GATE: float = Field(default=0.46, ge=0.0, le=1.0)
    ...
    MARGIN_PER_TRADE_MIN_PCT: float = Field(default=0.09, gt=0.0, le=0.5)
    MARGIN_PER_TRADE_MAX_PCT: float = Field(default=0.18, gt=0.0, le=1.0)
